	...
	public static class TokenizerMapper extends Mapper<Object, Text, IntWritable, Text> {
		...
		public void map(Object key, Text value, Context context) 
			...
			while (itr.hasMoreTokens()) {
				...
				// Need to keep track of the number of in-coming edges for the Combiner and/or Reducer to calculate average
				// <k, v>; k = NodeId, v = AverageLength_NumberOfInComingEdges
				context.write(new IntWritable(ToNodeId), new Text(Distance + "_1"));
			}
		}
	}
	
	// Combiner Class
	public static class AverageCombiner extends Reducer<IntWritable, Text, IntWritable, Text> {
		...
		public void reduce(IntWritable key, Iterable<Text> values, Context context)
			...
			// Still need to keep track of the number of in-coming edges for the Reducer to calculate average
			context.write(key, new Text(average + "_" + nEdges));
		}
	}
